...
//
// @Component({
//   selector: 'app-journal-charts',
//   templateUrl: './journal-charts.page.html',
//   styleUrls: ['./journal-charts.page.scss'],
//   encapsulation: ViewEncapsulation.None,
// })
// export class JournalChartsPage implements OnInit, AfterViewInit {
//
//   constructor() { }
//
//   ngOnInit() {
...
//       var xleft: any = new Date(x.domain()[0]);
//       var xright: any = new Date(x.domain()[1]);
//
